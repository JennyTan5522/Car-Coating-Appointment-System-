...
public class MainAppointment{
    ...
    public static void mainAppointment(UserInfo loginAccount , ArrayList<Service> serviceArrayList , ArrayList<Customer> customersArrayList , ArrayList<Car> carsArrayList , ArrayList<Appointment> appointmentArrayList) throws InterruptedException, IOException, ParseException {
        ...
        do {
            ...
            switch (choiceInt) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    editAppointmentMenu(appointmentArrayList, loginAccount, serviceArrayList);
                    break;
                case 4:
    ...
    public static void editAppointmentMenu(ArrayList<Appointment> appointmentArrayList,UserInfo userInfo ,ArrayList<Service> serviceArrayList ){
        Scanner input = new Scanner(System.in);
        if(userInfo instanceof Customer) {
            Customer customer = (Customer)userInfo;
            ...
            //if its admin
            System.out.println("\t\t\t\t\t  Admin is not allowed to edit appointment");
        }
    }
    ...
    public static void displaySpecificCarAppointment(ArrayList<Appointment> appointmentArrayList){
        ...
        if(localAppointment.size()!=0) {
            ...
            System.out.println(ANSI_RED+"\nSuccessfully quited search (car)"+ANSI_RESET);
        }
